...
public class AnalyzeSyntaxFromTextTest
{
    [Fact]
    public void AnalyzeSyntaxFromText()
    {
        var analyzeSyntaxFromTextSample = new AnalyzeSyntaxFromTextSample();
        var response = analyzeSyntaxFromTextSample.AnalyzeSyntaxFromText(LoggingFixture.text);
